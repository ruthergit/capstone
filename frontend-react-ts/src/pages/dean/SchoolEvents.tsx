  ...
  const handleApprovalClick = async (
    ...
    try {
      ...
      if (err.response && err.response.status === 403) {
        alert(
          err.response.data.message || "Previous approvers must approve first."
        );
      } else {
          ...
          <div className="bg-white rounded shadow-lg w-full max-w-md p-6">
            ...
            <div className="mt-4 flex h-10 justify-end gap-1">
              <button
                ...
                onClick={() => handleApprovalClick(currentApproval, "approved")}
              >
              ...
              <button
                ...
                disabled={submitting === currentApproval.id}
                onClick={() => handleApprovalClick(currentApproval, "rejected")}
              >
                <X size={14} /> Reject
              </button>
              ...
              <button
                ...
                disabled={submitting === currentApproval.id}
                onClick={() => handleApprovalClick(currentApproval, "revision")}
              >
