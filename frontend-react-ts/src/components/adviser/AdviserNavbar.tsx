      ...
      <div className="flex-1">
        <ul className="flex flex-col px-5 py-6 gap-3">
          <NavLink to="/adviser" end className={linkClass}>
              <Dashboard className={`w-4.5 ${iconFilter("/adviser")}`} /><p>Dashboard</p>
          </NavLink>
          <NavLink to="/adviser/school-events" className={linkClass}>
            <Calendar className={`w-4.5 ${iconFilter("/adviser/school-events")}`}/><p>School Events</p>
          </NavLink>
