      ...
      <div className="flex-1">
        <ul className="flex flex-col px-5 py-6 gap-3">
          <NavLink to="/organization" end className={linkClass}>
              <Dashboard className={`w-4.5 ${iconFilter("/organization")}`} /><p>Dashboard</p>
          </NavLink>
          <NavLink to="/organization/school-events" className={linkClass}>
            <Calendar className={`w-4.5 ${iconFilter("/organization/school-events")}`}/><p>School Events</p>
          </NavLink>
          <NavLink to="/organization/chats" className={linkClass}>
            <Chats className={`w-4.5 ${iconFilter("/organization/chats")}`} /><p>Chats</p>
          </NavLink>
        </ul>
      </div>
